...
export default function ProjectPage({
  ...
  if (loading)
    return (
      <div
        style={{ minHeight: '100vh', background: '#0F0C29', color: 'white' }}
      >
        {nav}
        <div style={{ textAlign: 'center', padding: 80, color: '#A5B4FC' }}>
          Loading...
        </div>
      </div>
    );
  ...
  const lms: Landmark[] = Array.isArray(project.landmarks)
    ? project.landmarks
    : [];
        ...
        <div>
          ...
          >
            ...
            >
              <span
                style={{
                  background:
                    project.status === 'Ready to Move' ? '#10B981' : '#F59E0B',
                  color: 'white',
                  fontSize: 11,
                  padding: '4px 12px',
                  borderRadius: 20,
          ...
          >
            {[
              ...
              [
                'Carpet Area',
                project.carpet_area_min
                  ? `${project.carpet_area_min}–${project.carpet_area_max} sqft`
                  : '—',
              ],
                  ...
                  >
                    <thead>
                      <tr style={{ background: 'rgba(79,70,229,0.2)' }}>
                        {['Type', 'Carpet Area', 'Price Range'].map((h) => (
                          <th
                            key={h}
                            style={{
                              padding: '10px 14px',
                    ...
                    <tbody>
                      {project.bhk_types.map((b, i) => (
                        ...
                        >
                          ...
                          <td
                            style={{ padding: '10px 14px', color: '#A5B4FC' }}
                          >
                            {fmt(project.price_min)} – {fmt(project.price_max)}
                          </td>
                        </tr>
          ...
          {tab === 'pitch' &&
            (project.pitch_script ? (
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 14, fontWeight: 600, color: '#A5B4FC' }}
                  >
                    Pitch Script
                  </div>
                  <span
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(project.pitch_script!);
                    setCopied(true);
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                background:
                  phone.length === 10 ? '#25D366' : 'rgba(37,211,102,0.2)',
                color: phone.length === 10 ? 'white' : '#64748B',
                fontWeight: 600,
